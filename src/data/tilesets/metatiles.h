...
const u16 gMetatiles_Snow_Tiles[] = INCBIN_U16("data/tilesets/primary/snow_tiles/metatiles.bin");
const u16 gMetatileAttributes_Snow_Tiles[] = INCBIN_U16("data/tilesets/primary/snow_tiles/metatile_attributes.bin");
